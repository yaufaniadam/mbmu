<div class="min-h-screen pt-24 pb-12 bg-gradient-to-br from-blue-50 via-white to-emerald-50">
    <div class="max-w-lg mx-auto px-4">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Pendaftaran Akun MBM</h1>
            <p class="text-gray-500 mt-1">Daftar untuk mengakses sistem SPPG</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <form wire:submit.prevent="validateToken">
                        <div class="mb-4">
                            <input 
                                ...
                                class="w-full px-4 py-3 text-center text-lg font-mono uppercase tracking-wider border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition"
                                maxlength="10"
                                autofocus
                            >
                        </div>
            ...
            @if($step === 2 && $registrationToken)
                <div class="p-6">
                    {{-- SPPG Info Banner --}}
                    <div class="bg-gradient-to-r from-emerald-50 to-blue-50 border border-emerald-200 rounded-xl p-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Mendaftar sebagai</p>
                                <p class="font-bold text-gray-900">{{ $roleLabels[$role] ?? $role }}</p>
                                <p class="text-sm text-emerald-700 font-medium mt-1">{{ $registrationToken->sppg->nama_sppg }}</p>
                            </div>
                        </div>
                    </div>
            ...
            @if($step === 3)
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-500 mb-6">Akun Anda telah dibuat dan siap digunakan</p>

                    {{-- Credentials Card --}}
                    <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6 text-left">
                        <h3 class="text-sm font-semibold text-gray-700 mb-3">Informasi Login Anda:</h3>
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                <span class="text-gray-500">Nomor HP:</span>
                                <span class="font-mono font-semibold text-gray-900">{{ $telepon }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-500">Password:</span>
                                <span class="font-mono font-semibold text-gray-900">{{ $generatedPassword }}</span>
                            </div>
                        </div>
                    ...
                    <a 
                        ...
                        class="inline-flex items-center justify-center w-full py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-blue-800 transition shadow-lg shadow-blue-200"
                    >
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
